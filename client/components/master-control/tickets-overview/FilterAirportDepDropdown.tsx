...
export default function FilterAirportDepDropdown({
  selectedAirportCode,
  onChangeHandler,
}: {
  selectedAirportCode: string;
  onChangeHandler: (airportCode: string) => void;
}) {
  // ############### STATES ##############
    ...
    <div>
      ...
      <div className="relative inline-flex w-full">
        <div
          ...
          className={`btn py-0 pl-0 w-full justify-between min-w-[11rem] h-[45px] bg-gray-100 dark:bg-gray-700 hover:border-red-300 dark:hover:border-red-500 hover:ring-1 hover:ring-red-500 text-gray-500 hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-200 ${
        ...
        {menuActive && (
          <div className="z-20 absolute top-full left-0 w-full bg-white dark:bg-gray-800 border border-gray-500 dark:border-gray-700 py-1.5 rounded shadow-lg overflow-hidden mt-1">
                ...
                options.map((option) => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      onChangeHandler(option.airportCode);
                    }}
                  >
