...
export default function TicketRequestsList({
  ticket,
}: {
  ...
  return (
    <>
      ...
      {/* Agency */}
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-[18%]">
        <div className="flex items-center ">
          ...
          <div className="font-medium text-slate-800 dark:text-slate-100 overflow-hidden whitespace-nowrap text-ellipsis">
      ...
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
        {/* Menu button */}
        <Link
          href={`/master-control/ticket-requests/${ticket.refId}`}
