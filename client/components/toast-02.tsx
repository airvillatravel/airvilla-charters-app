...
export default function Toast02({
  ...
  const typeColor = (type: string): string => {
    switch (type) {
      ...
      default:
        return "bg-red-100 dark:bg-red-400/30 border-red-200 dark:border-transparent text-red-500 dark:text-red-400";
    }
  };
    ...
    <>
      {open && (
        <div className={className} role="alert">
          <div
            className={`inline-flex min-w-[20rem] px-4 py-2 rounded-sm text-sm border ${typeColor(
              type
            )}`}
          >
