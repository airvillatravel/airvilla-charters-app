...
export default function DropdownProfile({
  ...
  return (
    <Popover className="relative inline-flex">
      ...
      <Transition
        className={`origin-top-right z-10 absolute top-full left-0 right-auto min-w-[14rem] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 pt-1.5 rounded shadow-lg overflow-hidden mt-1 ${
          align === "right"
