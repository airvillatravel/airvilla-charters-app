            ...
            <div className="py-4 px-2">
              ...
              <div className="mb-3 last:mb-0">
                ...
                <ul className="text-sm">
                  <li>
                    <Link
                      className="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-red-500 focus-within:text-white focus-within:bg-red-500 outline-none rounded group"
                      href="#0"
                    >
                      <svg
